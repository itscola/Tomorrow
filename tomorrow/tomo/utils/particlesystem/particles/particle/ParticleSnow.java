package tomorrow.tomo.utils.particlesystem.particles.particle;
...
public class ParticleSnow extends Particle {
   ...
   private void drawPixel(int xAdd) {
      ...
      for(int i = 0; i < 10; ++i) {
         ...
         RenderUtil.circle(this.vector.x, this.vector.y, size + 1.0F + (float)i * 0.2F, Helper.reAlpha(-1, (float)alpha));
      }
