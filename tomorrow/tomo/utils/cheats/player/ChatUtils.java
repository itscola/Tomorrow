    ...
    public static class ChatMessageBuilder {
        ...
        public ChatMessageBuilder(boolean prependDefaultPrefix, boolean useDefaultMessageColor) {
            if (prependDefaultPrefix) {
                ...
                this.theMessage.appendSibling(new ChatMessageBuilder(false, false).appendText(String.valueOf((Object) ((Object) EnumChatFormatting.DARK_GRAY) + Client.CLIENT_NAME + ": ")).setColor(EnumChatFormatting.RED).build().getChatComponent());
            }
