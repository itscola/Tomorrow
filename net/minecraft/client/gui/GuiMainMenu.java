...
import tomorrow.tomo.guis.login.GuiAltManager;
import tomorrow.tomo.utils.particlesystem.particle.Particle;
import tomorrow.tomo.utils.particlesystem.particles.ParticleManager;
...
//
        ...
        RenderUtil.drawCustomImage(new ScaledResolution(mc).getScaledWidth()/2-239f/4f,this.height / 4 - 25,239f/2f,142f/2f, new ResourceLocation("client/LOGO.png"));
        ...
        String s = Client.CLIENT_NAME + " " + Client.VERSION + " [Minecraft 1.8.8]";
        ...
        this.drawString(this.fontRendererObj, s1, this.width - this.fontRendererObj.getStringWidth(s1) - 4, this.height - 10, -1);
        this.drawString(this.fontRendererObj, "Tomorrow was made by SuperSkidder", this.width - this.fontRendererObj.getStringWidth("Tomorrow was made by SuperSkidder") - 4, this.height - 20, -1);
