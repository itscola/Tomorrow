...
import tomorrow.tomo.mods.modules.render.Animations;
                        ...
                        if (ModuleManager.getModuleByClass(Animations.class).isEnabled()) {
                            switch (Animations.mode.getModeAsString()) {
                                ...
                                case "Swang":
                                    ...
                                    GlStateManager.rotate((var15 * 30.0f / 2.0f), (-var15), 7.0f, 9.0f);
                                    GlStateManager.rotate((var15 * 40.0f), 1.0f, ((-var15) / 2.0f) + 7.0f, -0.0f);
                                    break;
                                case "Swank":
                                    this.transformFirstPersonItem(f / 2.0f, f1);
                                    float var16 = MathHelper.sin((MathHelper.sqrt_float(f1) * 3.1415927f));
                                    GlStateManager.rotate((var16 * 30.0f), (-var16), -0.0f, 9.0f);
                                    GlStateManager.rotate((var16 * 50.0f), 1.0f, (-var16), -0.0f);
                                    break;
                                default:
                                    this.transformFirstPersonItem(f, 0.0F);
                            }
